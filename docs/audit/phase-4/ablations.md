...
|-------------------|----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| Method            | Signature (fixed_30, fixed_90), CCF-at-lag (`ccf_fixed`), Dynamic baseline (`dynamic_adaptive`), RL (rl_ppo + variants) | All presets defined in `configs/scenarios/` and validated through `leadlag.hydra_main.validate_scenario_cfg`; CCF baseline extends the same reporting pipeline. |
