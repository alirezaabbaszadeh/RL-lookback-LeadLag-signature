...
def _compute_matrix_for_window(
    ...
    window_log_returns = analyzer._compute_log_returns_for_window(
        price_df, window_start, window_end
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "--config", type=str, required=True, help="Path to scenario YAML (extends base)"
    )
