...
def serialise_iteration_stats(
    stats_obj: iteration_stats.IterationStatistics,
) -> dict[str, list[Any]]:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=("Sanity-check Dopamine + Gymnasium 1.x installation via random rollouts.")
    )
